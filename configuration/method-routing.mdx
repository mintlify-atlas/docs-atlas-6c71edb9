...
```
method_route_hits_total{method="getSlot",backend="mainnet-primary"} 1543
load_balanced_requests_total{method="getBalance"} 892
```

Query routing statistics:

```bash
curl http://localhost:28901/metrics | grep method_route
```
